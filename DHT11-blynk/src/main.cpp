...
#define BLYNK_TEMPLATE_ID "TMPL6mc06H1vl"
#define BLYNK_TEMPLATE_NAME "DHT by Areeb"
#define BLYNK_AUTH_TOKEN    "WMaqtXRk7G56ObDsbx9f7CJB85DNvW7U"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
